...
public class SettingsController {
    ...
    static final String SETTINGS_PASSWORD_RUL = "/settings/password";
    ...
    @GetMapping(SETTINGS_PASSWORD_RUL)
    ...
    @PostMapping(SETTINGS_PASSWORD_RUL)
    public String updatePassword(@CurrentUser Account account,
        ...
        return "redirect:" + SETTINGS_PASSWORD_RUL;
    }
