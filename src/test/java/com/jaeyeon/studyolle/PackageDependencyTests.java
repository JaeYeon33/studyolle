...
public class PackageDependencyTests {
    ...
    @ArchTest
    ArchRule modulesPackageRule = classes().that().resideInAnyPackage("com.jaeyeon.studyolle.modules..")
            .should().onlyBeAccessed().byClassesThat()
            .resideInAnyPackage("com.jaeyeon.studyolle.modules..");
    ...
    @ArchTest
    ArchRule cycleCheck = slices().matching("..com.jaeyeon.studyolle.modules.(*)..")
